...
- **Project rollups** — Time aggregates by project. See where your hours really go.
...
- **Actual** — see what really happened
...
Group tasks by project. Each project shows total hours worked across all its tasks. The default "Other" project catches anything uncategorized.
...
- **Projects** — name, color, description
- **Tasks** — title, status, project, planned/actual dates and durations, timer state
...
| Shortcut | Action |
|----------|--------|
| `Enter` | Confirm task/project creation |
| `Escape` | Cancel task/project creation, close modal |
